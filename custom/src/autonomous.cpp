...
//   driveTo(2, 2000, true);               // drive little
//   turnToAngle(340, 2000, true);         // turn left little
//   driveTo(6, 2000, true, 9);            // arrive at the ball, wait a bit to take the ball

//   // go to matchloader
//   turnToAngle(240, 2000, true);
//   driveTo(14, 4000, true);
//   turnToAngle(180, 2000, true);
//   matchloader.set(true);
//   driveTo(16, 4000, true, 10);

//   // go to the longgoal
//   driveTo(-28, 2000, true);
...
// //   driveTo(10, 2000, true); // go to target
// //   turnToAngle(330, 2000, true);

// //   // driveTo(10, 2000, true);
// //   // matchloader.set(true);         // activate match loader
// // }

// // void score_7ball(){
// //   driveTo(10, 2000, true);  // backward
...
//   { // Wait for object to be close enough
//     wait(10, msec);
//   }
